...
module CalendarDateSelect
  ...
  Files = [
    '/vendor',
    '/vendor/javascripts/calendar_date_select',
    '/vendor/stylesheets/calendar_date_select',
    '/vendor/images/calendar_date_select',
    '/vendor/javascripts/calendar_date_select/locale'
  ]
